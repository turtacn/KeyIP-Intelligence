  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
      <Card className="flex flex-col h-full">
        <h3 className="text-lg font-semibold text-slate-800 mb-4">Input Claim</h3>
      ...
      <Card className="flex flex-col h-full bg-slate-50/50 overflow-hidden">
        <h3 className="text-lg font-semibold text-slate-800 mb-4">Analysis Report</h3>
        {loading ? (
          <div className="flex-1 flex flex-col items-center justify-center text-slate-500">
            <Loader2 className="w-10 h-10 animate-spin text-blue-600 mb-4" />
            <p>Scanning 50M+ documents...</p>
          </div>
        ) : report ? (
          <div className="flex-1 overflow-y-auto pr-2 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div>
              <h4 className="font-semibold text-slate-700 mb-3 text-sm">Closest Prior Art Documents</h4>
                  ...
                  <div key={i} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex gap-2">
                        <span className="font-medium text-slate-500 w-16 flex-shrink-0">Overlaps:</span>
                      ...
                      <div className="flex gap-2">
                        <span className="font-medium text-slate-500 w-16 flex-shrink-0">Differs:</span>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-slate-400 text-sm">
            ...
            <p>Enter claim text to see analysis results.</p>
          </div>
        )}
      </Card>
    </div>
