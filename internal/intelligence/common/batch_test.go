...
if !errors.Is(r.Error, errors.ErrCircuitOpen) {
...
if !errors.Is(err, errors.ErrShutdown) {
...
t.Errorf("DurationMs should be positive: %f", params.DurationMs)
}
}
